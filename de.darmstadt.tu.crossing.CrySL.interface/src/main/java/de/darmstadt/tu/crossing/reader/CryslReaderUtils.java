package de.darmstadt.tu.crossing.reader;
...
public class CryslReaderUtils {
	...
	protected static CrySLMethod stringifyMethodSignature(final Event lab) {
		...
		if (methodName == null) {
			methodName = ((de.darmstadt.tu.crossing.crySL.Domainmodel) (method.eContainer().eContainer().eContainer()))
					.getJavaType().getSimpleName();
		}
		final String qualifiedName = ((de.darmstadt.tu.crossing.crySL.Domainmodel) (method.eContainer().eContainer()
